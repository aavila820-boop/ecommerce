...
@section('content')
    <style>
        ...
        .auth-card {
            width: 100%;
            max-width: 980px;
            /* un poco más compacto que login/register */
            border-radius: 24px;
        ...
        /* Tu badge tal cual — con pequeños ajustes para el svg */
        .brand-badge {
            display: inline-flex;
            align-items: center;
            gap: 12px;
        ...
        <div class="auth-card">
            <div class="auth-grid">
                ...
                <div class="auth-brand">
                    ...
                    <h1 class="brand-title">Confirmar contraseña</h1>
                    <p class="brand-sub">Por seguridad, confirma tu contraseña para continuar con tu compra o gestión de
                        cuenta.</p>

                    <div class="brand-list">
                        <div class="brand-item"><i></i>Protección de datos y cifrado</div>
                        <div class="brand-item"><i></i>Mejor experiencia de compra</div>
                        <div class="brand-item"><i></i>Gestión segura de pedidos</div>
                    </div>
                </div>

                <!-- Formulario -->
                <div class="auth-form">
                    <div class="form-title">{{ __('Confirmar contraseña') }}</div>
                    <div class="form-subtitle">{{ __('Por favor confirma tu contraseña para continuar.') }}</div>
