        ...
        <div class="auth-card">
            <div class="auth-grid">
                ...
                <div class="auth-brand">
                    ...
                    <p class="brand-sub">Ingresa tu correo y define tu nueva contraseña para recuperar el acceso.</p>

                    <div class="brand-list">
                        <div class="brand-item"><i></i>Token seguro de restablecimiento</div>
                        <div class="brand-item"><i></i>Recomendado: contraseña robusta</div>
                        <div class="brand-item"><i></i>Proceso guiado y rápido</div>
                    </div>
                </div>
                ...
                <div class="auth-form">
                    ...
                    <div class="form-subtitle">{{ __('Completa los campos para actualizar tu acceso.') }}</div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn-update">{{ __('Actualizar contraseña') }}</button>
                        </div>
                    </form>
                </div>
