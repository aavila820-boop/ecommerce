...
@section('content')
    <style>
        /* ====== RESETS PARA ESTA VISTA (adiós espacios blancos) ====== */
        html,
        body {
            height: 100%;
        }
        ...
        /* Ocultar navbar sólo en esta pantalla */
        .navbar {
            display: none !important;
        }

        /* Quitar padding del main del layout */
        #app>main {
            padding: 0 !important;
        }
        ...
        /* header del formulario con CTA crear cuenta en esquina superior derecha */
        .form-head {
            display: flex;
            align-items: center;
        ...
        /* CTA Crear cuenta grande (posición nueva) */
        .btn-cta-register {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            ...
            letter-spacing: .4px;
            background:
                linear-gradient(#0b1f48, #0b1f48) padding-box,
                linear-gradient(180deg, var(--secondary-cyan), #4be3ff) border-box;
        ...
        .btn-cta-register:hover {
            ...
            box-shadow: 0 14px 30px rgba(0, 188, 212, .36);
        ...
        /* Botón secundario (ahora pequeño debajo como link-ghost) */
        .btn-register-inline {
        ...
        <div class="auth-card">
            <div class="auth-grid">
                ...
                <div class="auth-brand">
                    ...
                    <p class="brand-sub">Una experiencia rápida, segura y con estilo. Entra y sigue donde lo dejaste.</p>

                    <div class="brand-list">
                        <div class="brand-item"><i></i>Autenticación segura y cifrada</div>
                        <div class="brand-item"><i></i>UI limpia con modo glass</div>
                        <div class="brand-item"><i></i>Rendimiento 🏎️ con Bootstrap 5</div>
                    </div>
                </div>
                ...
                <div class="auth-form">
                    <div class="form-head">
                        <div>
                            ...
                            <div class="form-subtitle">Accede con tu correo y contraseña.</div>
                        </div>
                    </div>
                    1
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group-custom">
                            ...
                            <input id="password" type="password"
                                class="form-control-custom @error('password') is-invalid @enderror" name="password" required
                        ...
                        <div class="form-options">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="remember">{{ __('Mantener sesión') }}</label>
                            </div>
                        ...
                        {{-- CTA secundario opcional debajo (link) --}}
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn-register-inline">¿Nuevo por aquí? Crea tu
                                cuenta</a>
                        @endif
                    </form>
                </div>
