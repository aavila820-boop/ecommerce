...
@section('content')
    <style>
        ...
        /* CTA “Inicia sesión” arriba a la derecha */
        .btn-cta-login {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            ...
            font-weight: 800;
            letter-spacing: .4px;
            background: linear-gradient(#0b1f48, #0b1f48) padding-box,
        ...
        <div class="auth-card">
            <div class="auth-grid">
                ...
                <div class="auth-brand">
                    ...
                    <p class="brand-sub">Únete y descubre los mejores electrodomésticos, ofertas y una experiencia de compra
                        fluida.</p>

                    <div class="brand-list">
                        <div class="brand-item"><i></i>Garantía y soporte oficial</div>
                        <div class="brand-item"><i></i>Pagos seguros y rápidos</div>
                        <div class="brand-item"><i></i>Recomendaciones inteligentes</div>
                    </div>
                </div>
                ...
                <div class="auth-form">
                    <div class="form-head">
                        <div>
                            <div class="form-title">{{ __('Crear cuenta') }}</div>
                            <div class="form-subtitle">Completa tus datos para empezar.</div>
                        </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group-custom">
                            ...
                            <input id="name" type="text"
                                class="form-control-custom @error('name') is-invalid @enderror" name="name"
                                value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Tu nombre">
                            @error('name')
                        ...
                        <button type="submit" class="btn-register">{{ __('Crear cuenta') }}</button>

                        {{-- Link secundario --}}
                        @if (Route::has('login'))
                            <a href="{{ route('login') }}" class="inline-login">¿Ya tienes cuenta? Inicia sesión</a>
                        @endif
                    </form>
                </div>
            </div>
