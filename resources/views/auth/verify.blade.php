        ...
        <div class="auth-card">
            <div class="auth-grid">
                ...
                <div class="auth-brand">
                    ...
                    <h1 class="brand-title">Verifica tu correo</h1>
                    <p class="brand-sub">Te enviamos un enlace de verificación. Revisa tu bandeja de entrada (y spam, por si
                        acaso).</p>

                    <div class="brand-list">
                        <div class="brand-item"><i></i>Seguridad y confianza</div>
                        <div class="brand-item"><i></i>Activa tu cuenta para comprar</div>
                        <div class="brand-item"><i></i>Proceso rápido</div>
                    </div>
                </div>

                <!-- Contenido / acciones -->
                <div class="auth-form">
                    <div class="form-title">{{ __('Verificación de correo') }}</div>
                    <div class="form-subtitle">
                        {{ __('Antes de continuar, revisa tu correo para el enlace de verificación.') }}</div>

                    @if (session('resent'))
                        <div class="alert-glass" role="alert">
                            {{ __('Hemos enviado un nuevo enlace de verificación a tu correo.') }}
                        </div>
                    @endif

                    <div class="info-text">
                        {{ __('Si no recibiste el correo, puedes solicitar otro:') }}
                    </div>
